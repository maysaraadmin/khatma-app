...
class JoinRequest(models.Model):
    ...
    STATUS_CHOICES = [('pending', 'قيد الانتظار'), ('approved', 'تمت الموافقة'), ('rejected', 'تم الرفض')]
    user = models.ForeignKey(User, on_delete=models.CASCADE, verbose_name='المستخدم')
    group = models.ForeignKey(ReadingGroup, on_delete=models.CASCADE, verbose_name='المجموعة')
...
class GroupEvent(models.Model):
    ...
    EVENT_TYPE_CHOICES = [('meeting', 'اجتماع'), ('khatma_start', 'بدء ختمة'), ('khatma_completion', 'إكمال ختمة'), ('lecture', 'محاضرة'), ('other', 'أخرى')]
