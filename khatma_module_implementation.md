# Khatma Module Implementation Guide

This guide provides detailed instructions for implementing the Khatma module as part of the app refactoring plan.
...
│       ├── khatma_part.html
│       ├── khatma_share.html
│       ├── deceased_detail.html
│       ├── deceased_list.html
│       └── create_deceased.html
├── tests/
│   ├── __init__.py
│   ├── test_forms.py
│   ├── test_models.py
...
### __init__.py
```python
default_app_config = 'khatma.apps.KhatmaConfig'
```
