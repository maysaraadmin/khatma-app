...
# We're not registering Notification here because it's already registered by django-notifications-hq
# If you need to customize the admin, you can unregister and re-register it
