...
class Notification(models.Model):
    ...
    NOTIFICATION_TYPES = [
        ...
        ('khatma_completed', 'اكتمال الختمة'),
        ('part_assigned', 'تعيين جزء'),
        ('part_completed', 'إكمال جزء'),
        ('memorial_khatma', 'ختمة تذكارية'),
        
        # Group related
        ('new_group_member', 'عضو جديد في المجموعة'),
        ('group_member_left', 'مغادرة عضو للمجموعة'),
        ('join_request', 'طلب انضمام'),
        ('join_request_approved', 'قبول طلب انضمام'),
        ('join_request_rejected', 'رفض طلب انضمام'),
        ('role_changed', 'تغيير الدور'),
        ('removed_from_group', 'إزالة من المجموعة'),
