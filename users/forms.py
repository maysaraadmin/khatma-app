...
class UserProfileForm(forms.ModelForm):
    ...
    class Meta:
        model = Profile
        fields = ('account_type', 'preferred_language', 'reading_preference', 
                  'font_size', 'night_mode', 'email_notifications', 'push_notifications')
        widgets = {
...
class UserProfileEditForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ('profile_picture', 'bio', 'location', 'birth_date', 
                  'family_name', 'organization_name', 'organization_website', 'organization_logo')
        widgets = {
